...
public class ExtendRoleModelConverter extends RoleModelConverter {
    ...
    public ExtResourceRoleModel createExtResourceRoleModel(ResourceRole role) {
        ExtResourceRoleModel roleModel = this.metadata.create(ExtResourceRoleModel.class);
